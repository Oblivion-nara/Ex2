...
public class Request {
	...
	public static final int MESSAGE = 1;		// message: user: followed by message
	public static final int GAMEUPDATE = 2;		// game: user: game coordinates (x,y)
	...
	public static final int GIVEUP = 6;			// quit: user
	public static final int EXIT = 7;			// exit
												// 'user' is always the other person
